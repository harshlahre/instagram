...
export const metadata: Metadata = {
  ...
  description:
    "This website (igramsaver.io) is not affiliated with Meta or Instagram in any way. Also, this website does not violate any policy or guideline of",
  alternates: {
...
const DisclaimerPage = () => {
  return (
    <div className="my-4 flex flex-col rounded-lg border p-8">
      <h1 className="home-h1 mb-4 text-2xl">Disclaimer</h1>
      <section className="terms-privacy">
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to iGram Saver
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to iGram Saver, accessible from{" "}
        ...
        <noindex>
          <p>
            This website (igramsaver.io) is not affiliated with Meta or
            Instagram in any way. Also, this website does not violate any policy
            or guideline of Instagram or Meta, we don't host instagram videos on
            our website. The website or the owner is not liable for any damage
            caused to any user.
          </p>
        </noindex>
        <p>

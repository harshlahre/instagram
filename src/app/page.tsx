    ...
    <div className="flex flex-col py-8">
      ...
      <section className="section-text">
        <div className="section-text__card">
          <img src="/images/instagram-bg.webp" alt="Instagram Reels Download" width="289" height="220"/>
...
<ul className="down-steps">
    <li>
        <img src="/images/media-steps1.webp" loading="lazy" alt="Copy the URL" width="312" height="198"/>
        <div>
            <h3>Copy the Link</h3>
    ...
    <li>
        <img src="/images/media-steps2.webp" loading="lazy" alt="Paste the link" width="312" height="198"/>
        <div>
    ...
    <li>
        <img src="/images/media-steps3.webp" loading="lazy" alt="Download" width="312" height="198"/>
        <div>
            <h3>Download</h3>

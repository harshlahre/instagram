...
export const metadata: Metadata = {
  ...
  description:
    "Welcome to iGram Saver! These terms and conditions outline the rules and regulations for the use of iGram Saver's Website, located at",
  alternates: {
  ...
  openGraph: {
    title: "Terms Of Service - iGram Saver",
    description:
      "Welcome to iGram Saver! These terms and conditions outline the rules and regulations for the use of iGram Saver Website, located at",
...
const TermsOfServicePage = () => {
  return (
    <div className="my-4 flex flex-col rounded-lg border p-8">
      <h1 className="home-h1 mb-4 text-2xl">Terms of Service</h1>
      <section className="terms-privacy">
        <p>
          Welcome to iGram Saver! These terms and conditions outline the rules
          and regulations for the use of iGram Saver's Website, located at{" "}
          <Link href="/">https://igramsaver.io</Link>.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use iGram Saver if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing iGram Saver, you agreed to
          use cookies in agreement with the iGram Saver's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, iGram Saver and/or its licensors own the
          intellectual property rights for all material on iGram Saver. All
          intellectual property rights are reserved. You may access this from
          iGram Saver for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          iGram Saver does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of iGram Saver, its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, iGram Saver
        ...
        <p>
          iGram Saver reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant iGram Saver a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of iGram Saver; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to iGram Saver. Please include your name, your
        ...
        <p>
          No use of iGram Saver's logo or other artwork will be allowed for
